...
#'
#' \code{fat2.ad2.crd} Analyses experiments in balanced
...
anavaT<-data.frame("DF"=c(gla, glb, glab, glad, glad, glE, glT ),
                   "SS"=c(round(c(SQa,SQb,SQab,SQad1,SQad2,SQE,SQT),5)),
                   "MS"=c(round(c(QMa,QMb,QMab,QMad1,QMad2,QME,QMT),5)),
...
anavad1<-data.frame("DF"=c(glb, glf1, glad, glad, glE, glT),
                    "SS"=c(round(c(SQb,SQf1,SQad1,SQad2,SQE,SQT),5)),
                    "MS"=c(round(c(QMb,QMf1,QMad1,QMad2,QME,QMT),5)),
...
anavad2<-data.frame("DF"=c(gla, glf2, glad, glad, glE, glT),
                    "SS"=c(round(c(SQa,SQf2,SQad1,SQad2,SQE,SQT),5)),
                    "MS"=c(round(c(QMa,QMf2,QMad1,QMad2,QME,QMT),5)),
