...
#'
#' \code{fat3.crd} Analyses experiments in balanced Completely
...
fat3.crd <-
function(factor1, factor2, factor3, resp, quali=c(TRUE,TRUE,TRUE), mcomp='tukey',
                   fac.names=c('F1','F2','F3'), sigT=0.05, sigF=0.05) {
