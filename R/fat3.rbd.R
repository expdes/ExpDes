...
#'
#' \code{fat3.rbd} Analyses experiments in balanced Randomized
...
#' \code{\link{fat3.ad.crd}} and \code{\link{fat3.ad.crd}}.
#' @examples
#' data(ex6)
#' attach(ex6)
...
"MS"=c(round(c(QMB,QMa,QMb,QMc,QMab,QMac,QMbc,QMabc,QME),5),''),
